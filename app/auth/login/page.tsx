    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 48 }}>
          ...
          }}><img src="/logo-placeholder.svg" alt="Popular" style={{ width:24, height:24, objectFit:"contain" }} /></div>
          <span style={{ fontWeight: 700, fontSize: '1.3rem' }}>Popular</span>
        </div>

        <div style={{ marginBottom: 32 }}>
          <div style={{ width: 48, height: 4, background: 'var(--color-yellow)', borderRadius: 2, marginBottom: 12 }} />
          <h1 style={{ fontWeight: 700, fontSize: '2rem', margin: 0 }}>Let the fun begin!</h1>
        </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 24 }}>
          ...
          <span style={{ color: 'var(--color-muted)', fontSize: '0.85rem' }}>or</span>
          <div style={{ flex: 1, height: 1, background: '#ddd' }} />
        </div>

        {/* Email/Password */}
        <div style={{ marginBottom: 16 }}>
          <label style={{ display: 'block', fontWeight: 500, marginBottom: 6, fontSize: '0.9rem' }}>
            Username
          </label>
          <input
            type="email"
            ...
            style={{
              ...
              fontFamily: 'var(--font-haas)', outline: 'none',
        ...
        <button onClick={signInWithEmail} disabled={loading} style={{
        ...
        <p style={{ margin: '0 0 16px', fontSize: '0.9rem' }}>
          ...
          <a href="#" style={{ fontWeight: 700, color: 'inherit', textDecoration: 'underline' }}>
            Make one now!
          </a>
        </p>

        <div style={{ display: 'flex', gap: 24 }}>
          <a href="#" style={{ fontWeight: 700, fontSize: '0.9rem', color: 'inherit', textDecoration: 'underline' }}>
            Society Log In
          </a>
          <a href="#" style={{ fontWeight: 700, fontSize: '0.9rem', color: 'inherit', textDecoration: 'underline' }}>
            Forgot Password
